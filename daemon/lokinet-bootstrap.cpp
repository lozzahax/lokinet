...
main(int argc, char* argv[])
{
  const std::unordered_map<std::string, std::string> bootstrap_urls = {
      {"mainnet", "https://seed.lozzax.xyz/lokinet.signed"},
      {"lokinet", "https://seed.lozzax.xyz/lokinet.signed"},
      {"testnet", "https://seed.lozzax.xyz/testnet.signed"},
      {"gamma", "https://seed.lozzax.xyz/testnet.signed"}};
